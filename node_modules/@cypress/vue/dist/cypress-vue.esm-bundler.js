...
import { enableAutoDestroy, createLocalVue, mount as mount$1 } from '@vue/test-utils';
import { injectStylesBeforeElement, ROOT_ID, setupHooks } from '@cypress/mount-utils';
...
var mount = function (component, optionsOrProps) {
    ...
    return cy
        ...
        var VTUWrapper = mount$1(wrapper, __assign({ localVue: localVue }, props));
