import "./chunk-WH6MESSM.js";
import "./chunk-DRQU7GE7.js";
import "./chunk-FQTNARUV.js";
import "./chunk-7LVPS675.js";
import {
  init,
  throttle
} from "./chunk-3MT6EOVV.js";
import "./chunk-FM53ZRVE.js";
import "./chunk-QRPMUKJX.js";
import "./chunk-225AN63H.js";
import {
  Plugin,
  computed,
  createElement,
...
var Vue2 = vue_runtime_esm_default;
...
function createElement2(tagName, props) {
  if (props === void 0)
    props = {};
...
function initTriggers(elem) {
  ...
  var triggers = createElement2("div", {
    className: "resize-triggers"
  });
  var expand = createElement2("div", {
    className: "resize-expand-trigger"
  });
  var expandChild = createElement2("div");
  var contract = createElement2("div", {
...
function b(e) {
  return t = /* @__PURE__ */ Object.create(null), m.forEach(function(n) {
    t[n] = function(t2) {
      return function() {
...
var U = defineComponent({ name: "echarts", props: O(O({ option: Object, theme: { type: [Object, String] }, initOptions: Object, updateOptions: Object, group: String, manualUpdate: Boolean }, y), j), inheritAttrs: false, setup: function(i, l) {
  ...
  return e.ref = "root", e.class = e.class ? ["echarts"].concat(e.class) : "echarts", createElement("x-vue-echarts", e);
} });
